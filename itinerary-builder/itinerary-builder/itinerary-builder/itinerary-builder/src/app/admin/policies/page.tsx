...
export default function PoliciesPage() {
  ...
  async function load() { setLoading(true); const r = await fetch('/api/v1/policies'); const d = await r.json(); if (d.success) setRows(Array.isArray(d.data) ? d.data : []); setLoading(false); }
  useEffect(() => { load(); }, []);
