 ...
 * Updates the discount on a single QuoteOption, recalculates all derived
 * pricing fields, persists, and auto-republishes the snapshot so the
 * customer itinerary reflects the change immediately.
 */
...
export async function PATCH(
  ...
  const { discount_amount, discount_expires_at } = parsed.data;
