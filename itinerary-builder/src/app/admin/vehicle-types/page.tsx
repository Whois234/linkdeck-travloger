...
export default function VehicleTypesPage() {
  ...
  const sorted = useMemo(() => {
    ...
    else if (sortKey === 'az') arr.sort((a, b) => a.display_name.localeCompare(b.display_name));
    else if (sortKey === 'za') arr.sort((a, b) => b.display_name.localeCompare(a.display_name));
    return arr;
  }, [rows, sortKey]);
