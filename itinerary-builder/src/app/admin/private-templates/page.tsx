...
import { Plus, Search, Pencil, Trash2, FileText, Map, ChevronRight } from 'lucide-react';
...
export default function PrivateTemplatesPage() {
  ...
  const filtered = rows.filter(r =>
    !search || r.template_name.toLowerCase().includes(search.toLowerCase()) ||
    ...
    <div className="max-w-[1400px]">
      ...
      {loading ? (
        ...
        <div className="py-20 text-center bg-white rounded-2xl" style={{ border: '1px solid #E2E8F0' }}>
          ...
          <p className="text-sm mt-1 text-[#64748B]">Create your first private template to get started</p>
        </div>
      ) : (
